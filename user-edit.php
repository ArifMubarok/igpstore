...
if (isset($_POST['update'])) {
    ...
    mysqli_query($conn, "UPDATE tb_user SET nama_lengkap='$nama', username='$username', `role`='$role' WHERE id=$id");
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2" method="POST" action="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Nama Lengkap" value="<?php echo $nama; ?>"
                                                name="nama_lengkap" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <select class=" form-select" name="role" value="<?php echo $role; ?>">
