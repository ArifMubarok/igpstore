                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2" method="POST" action=""
                                    ...
                                    $id = $_GET['id'];
                                    $rows = query("SELECT * FROM tb_data_barang WHERE id = $id");
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="number" name="stock_barang" id="stock_barang"
                                                value="<?php echo $row['stock_barang'] ?>"
                                                class="form-control form-control-line" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea type="textarea" name="deskripsi" id="deskripsi"
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12">Ganti foto barang</label>
                                        <img src="./assets/images/data_barang/<?php echo $row["foto"]; ?>" alt="gambar"
                                            width="150">
                                        <div class="input-group">
                                            <span class="input-group-text col-2">Upload</span>
                                            <input type="file" name="foto" id="foto" value="<?php echo $row["foto"] ?>"
                                                class="custom-file-input col-8 ps-1 pt-1">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
