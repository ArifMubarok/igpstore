...
$db = mysqli_connect('localhost', 'root', '', 'db_customer');
                        ...
                        <div class="card">
                            <div class="card-body">
                                <center class="mt-4"> <img src="assets/images/users/default-profile.jpg"
                                    ...
                                    <h6 class="card-subtitle">Admin IGP Store</h6>
                                </center>
                            </div>
                            <div>
                                <hr>
                            </div>
                            <div class=" card-body text-center"> <small class="text-muted">Username / Email</small>
                                <h6>
                                    <?php echo $_SESSION['username'] ?>
                                </h6>
                                <!-- <div class="text-center">
                                            <a type="button" class="btn btn-outline-secondary"
                                                href="update-profile-admin.php?id=<?php echo $row["id"]; ?>"
