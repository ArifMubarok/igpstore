            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Riwayat Belanja</h4>
                    </div>
                            ...
                            <table class="table table-light table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col-4">Tanggal Pembelian</th>
                                        <th scope="col-2">Jasa Pengiriman</th>
                                        <th scope="col-2">Status</th>
                                        <th scope="col-2">Total Harga</th>
                                        <th scope="col-2">Nota / Pembayaran</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php
                                    $pelanggan = mysqli_query($conn, "SELECT * FROM tb_user JOIN pembelian ON tb_user.id=pembelian.id_user WHERE username='$_SESSION[username]' ");
                                    while ($data_pelanggan = mysqli_fetch_assoc($pelanggan)) :
                                    ?>
                                    <tr>
                                        <td><?php echo $i ?></td>
                                        <td><?php echo $data_pelanggan['tanggal']; ?></td>
                                        <td><?php echo $data_pelanggan['kurir']; ?></td>
                                        <td><?php echo $data_pelanggan['status_pembelian']; ?></td>
                                        <td>Rp <?php echo number_format($data_pelanggan['total_harga']) ?></td>
                                        <td>
                                            <div class="btn-group" role="group" aria-label="ket">
                                                <a class="btn btn-outline-secondary"
                                                    href="nota.php?id=<?php echo $data_pelanggan['id']; ?>"
                                                    role="button">Nota</a>
                                                <a class="btn btn-outline-secondary"
                                                    href="pembayaran.php?id=<?php echo $data_pelanggan['id']; ?>"
