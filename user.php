...
$rows = query("SELECT * FROM tb_user");
                        ...
                        <div class="card">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th scope="col" class="col-2">Username / email</th>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group" aria-label="ket">
                                                    <a class="btn btn-outline-secondary"
                                                        href="delete-akun.php?id= <?php echo $row['id'] ?>"
                                                        onclick="return confirm('Apakah anda yakin untuk menghapus data ?')"
                                                        role="button">Delete</a>
                                                    <a class="btn btn-outline-secondary"
                                                        href="user-edit.php?id= <?php echo $row['id']; ?>"
                                ...
                                <div class="col pe-3 pb-3 text-end">
                                    <a type="button" class="btn btn-outline-secondary" href="regist-admin.php"
                                        role="button">Daftarkan akun</a>
                                </div>
                            </div>
                        </div>
                    </div>
