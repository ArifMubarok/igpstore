            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Data Transaksi Pelanggan</h4>
                            </div>
                                ...
                                <table class="table">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th scope="col" class="col-4">Nama Pelanggan</th>
                                            <th scope="col" class="col-2">Tanggal Pembelian</th>
                                    ...
                                    <tbody>
                                        <?php
                                        $count = 1;
                                        $databeli = mysqli_query($conn, "SELECT * FROM pembelian JOIN tb_user ON pembelian.id_user=tb_user.id");

                                        while ($datapembelian = mysqli_fetch_assoc($databeli)) :
                                        ?>
                                        <tr>
                                            <th scope="row"><?php echo $count; ?></th>
                                            <td><?php echo $datapembelian['nama_lengkap']; ?></td>
                                            <td><?php echo $datapembelian['tanggal']; ?></td>
                                            <td><?php echo $datapembelian['status_pembelian']; ?></td>
                                            <td>Rp <?php echo number_format($datapembelian['total_harga']) ?></td>
                                        </tr>
                                        <?php $count++; ?>
                                        <?php endwhile; ?>
                                    </tbody>
