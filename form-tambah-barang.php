                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="tabel-penjualan.php">Data Barang</a>
                                    </li>
            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-8 col-xlg-9">
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2" method="POST" action="upload.php"
                                    enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label class="col-md-12">Nama Barang</label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Nama Barang" name="nama_barang"
                                                id="nama_barang" class="form-control form-control-line" required
                                                autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="number" placeholder="Berat (Gram)" name="berat" id="berat"
                                                class="form-control form-control-line" required autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Stock Barang</label>
                                        <div class="col-md-12">
                                            <input type="number" placeholder="Stock" name="stock_barang"
                                                id="stock_barang" class="form-control form-control-line" required
                                                autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12">Deskripsi Barang</label>
                                        <div class="col-md-12">
                                            <textarea type="textarea" placeholder="Deskripsi" name="deskripsi"
                                                id="deskripsi" class="form-control form-control-line" required
                                                autocomplete="off"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Upload foto barang</label>
                                        <div class="input-group">
                                            <span class="input-group-text col-2">Upload</span>
                                            <input type="file" name="foto" class="custom-file-input col-8 ps-1 pt-1">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-success text-white" type="submit"
                                                name="add">Tambah</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
