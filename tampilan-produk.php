            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Produk Yang Dijual</h4>
                    </div>
                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Produk Yang Dijual</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="card" style="min-height: 220px;">
                            <div class="card-body">
                                <h4 class="card-title">Produk IGP - <?php echo $row['nama_barang'] ?></h4>
                                <div class="text-center">
                                    <img src="./assets/images/data_barang/<?php echo $row['foto'] ?>" class="rectangle"
                                        alt="produkIGP" width="150">
                                </div>
                                <div class="txt-oflo" style="text-align: center;">
                                    <h5><b>Rp <?php echo number_format($row['harga']) ?></b></h5>
                                </div>
                                <div class="txt-oflo">Nama Barang : <?php echo $row['nama_barang'] ?></div>
                                <div class="txt-oflo">Kondisi : <?php echo $row['kondisi'] ?></div>
                                <div class="txt-oflo">Berat : <?php echo number_format($row['berat']) ?> Gram</div>
                                <div class="txt-oflo">Deskripsi : </div>
                                <div class="txt-oflo"><?php echo $row['deskripsi'] ?></div>
                                <a class="btn btn-outline-success mt-3"
                                    href="masuk-keranjang.php?id=<?php echo $row['id']; ?>" type="button"
